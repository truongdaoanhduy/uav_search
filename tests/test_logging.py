...
def test_run_logger_writes_metrics_low_episode_and_error(tmp_path):
    ...
    logger.log_episode({
        ...
        "safety_distance_violation_uavs": 0, "obstacle_hit_uavs": 0, "depleted_uavs": 0, "avg_battery_pct": 99.0,
    ...
    low_payload = logger.log_episode({
        ...
        "safety_distance_violation_uavs": 3, "obstacle_hit_uavs": 2, "depleted_uavs": 1, "avg_battery_pct": 8.0,
    ...
    assert "safety_distance_violation_high" in low["signals"]
