...
def test_online_logger_streams_diagnostics_and_artifacts(monkeypatch, tmp_path):
    ...
    logger.log_low_episode({"episode": 2, "search_rate": 0.0, "signals": ["search_low"], "severity": "critical", "failure_scope": "rotor_group", "primary_cause": "communication"})
    ...
    assert "diagnostics/low_worst_agent" not in logged_keys
